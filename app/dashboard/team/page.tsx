...
export default function TeamPage() {
  ...
  const handleDeleteMember = async (memberId: string) => {
    if (!confirm("Are you sure you want to remove this member? They will lose access to this organization immediately.")) return;

    try {
      const res = await fetch(`${API_BASE}/organization/member/${memberId}`, {
        method: 'DELETE',
        credentials: "include",
      });
